  ...
  **/
  ...
  function tmpl$6($api, $cmp, $slotset, $ctx) {
    ...
    return [api_custom_element("lightning-card", _lightningCard, {
      ...
      key: 37
    }, [api_text("New Personal Best: "), api_dynamic($cmp.activitiesCompleted2)])]) : null])]), api_element("div", {
      classMap: {
        "slds-media": true,
        "slds-m-top_medium": true,
        "slds-m-bottom_small": true
  ...
  class ActivityScorecard extends lwc.LightningElement {
    constructor(...args) {
      super(...args);
      this.Title = "Activity Scorecard - Last 30 Days";
    ...
    get progressBar1Style() {
      return "background:" + this.progressBarColor1 + ";";
    }
